...
<div class="container">
	...
	<div class="collapse navbar-collapse" id="navbarsExampleDefault">
		...
		<!-- End Menu -->
		<!-- Begin Search -->
		<form class="form-inline my-2 my-lg-0" action="{{ route('query') }}" method="GET">
			<input class="form-control mr-sm-2" type="text" placeholder="Press Enter to Search" name="search">
